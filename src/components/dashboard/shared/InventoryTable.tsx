  ...
  return (
    <div className=" border border-slate-100 shadow p-2">
      ...
      <div className="max-h-[60vh] overflow-auto relative">
        <Table onScroll={(evt) => console.log(evt, "i scroll")}>
          ...
          {/* <TableFooter className=''>
            <TableRow className=' bg-slate-200 '>
              ...
              <TableCell className='text-center w-[81px]'></TableCell>
              <TableCell className='text-center w-[91px]'></TableCell>
              <TableCell className='text-center w-[127px]'></TableCell>
              <TableCell className='text-center w-[84px]'></TableCell>
              <TableCell className='text-center w-[141px] font-bold text-base text-slate-700'>
                &#8358;{totals.amountSupplied.toLocaleString()}
              </TableCell>
              <TableCell className='text-center w-[105px]'></TableCell>
              <TableCell className='text-center w-[108px] font-bold text-base text-slate-700'>
                &#8358;{totals.amountSold.toLocaleString()}
              </TableCell>
              <TableCell className='text-center w-[134px]'></TableCell>
      ...
      <footer className="w-full overflow-auto">
        <Table className="w-[1285.5px]">
          <TableFooter className="">
            <TableRow className=" bg-slate-200 ">
              <TableCell className="text-center w-[104px]"></TableCell>
              <TableCell className="text-center w-[87px]"></TableCell>
              <TableCell className="text-center w-[111px]"></TableCell>
              <TableCell className="text-center w-[155px]"></TableCell>
              <TableCell className="text-center w-[95px]"></TableCell>
              <TableCell className="text-center w-[170px] font-bold text-base text-slate-700 border border-slate-100">
                &#8358;{totals.amountSupplied.toLocaleString()}
              </TableCell>
              <TableCell className="text-center w-[120px]"></TableCell>
              <TableCell className="text-center w-[119px] font-bold text-base text-slate-700 border border-slate-100">
                &#8358;{totals.amountSold.toLocaleString()}
              </TableCell>
              <TableCell className="text-center w-[160px]"></TableCell>
              <TableCell className="text-center w-[160px] font-bold text-base text-slate-700 border border-slate-100">
                &#8358;{totals.amountRemaining.toLocaleString()}
              </TableCell>
            </TableRow>
          </TableFooter>

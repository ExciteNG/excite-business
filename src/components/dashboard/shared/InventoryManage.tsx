		...
		<div className="w-full h-[80vh]">
			{inventoryState.add ? (
				<div className="w-full h-full space-y-5">
					<div
						className="p-2 cursor-pointer border border-slate-300 rounded-full shadow w-fit"
						onClick={addProduct}
					>
					...
					<div>
						<h1 className="font-semibold text-xl">Fill Inventory Details</h1>
						<p>
							Enter the required inventory information to ensure accurate

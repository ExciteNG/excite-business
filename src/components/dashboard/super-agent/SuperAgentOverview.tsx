    ...
    <section className="w-full">
      <div className="w-full flex justify-between gap-4 items-center">
        <div className="flex gap-2">
          ...
          <button className="bg-[#A7CC48] py-2 px-6 rounded-md font-medium">Search</button>
        </div>
        <div>
          <p className="text-sm font-medium flex items-center gap-2">Referral Code: <span className="font-semibold">SBC/NIG/SA/201</span> <Copy className="w-4 h-4" /> </p>
        </div>
      </div>
      ...
      <div className="w-full flex gap-4">
        <div className="w-2/3 border my-4 rounded-md p-4">
          ...
          <p className="text-xs ">Keep track of Distributors sale every month</p>

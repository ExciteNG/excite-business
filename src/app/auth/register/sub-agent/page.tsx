...
import authBg from "../../../../../public/img/auth-bg.png";
      ...
      <section className="flex-1">
        <div className="w-full h-full relative flex justify-center overflow-y-scroll no-scrollbar">
          <div className="w-[90%] max-w-[30rem] py-6 px-4">
            ...
            <p className="text-sm my-2">By creating an account, you agree to Excite Trade’s <Link href="" className="text-[#A7CC48]">Terms of Service</Link> and <Link href="" className="text-[#A7CC48]">Privacy Policy.</Link></p>
            <p className="text-sm font-light">
              Already have an account?{" "}
              <Link href="/auth/sign-in" className="text-[#A7CC48] hover-[#86ac25]">
                Sign In
              </Link>
            </p>
          </div>
